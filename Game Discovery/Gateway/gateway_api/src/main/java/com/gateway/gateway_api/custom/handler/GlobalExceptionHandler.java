...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleWebClientRequestException(
      Exception ex, WebRequest request) {
    	ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, "WebClient Exception", ex.getMessage());
    	
        return new ResponseEntity<>(apiError, apiError.getStatus());
    }
    
    @ExceptionHandler({ RedisConnectionFailureException.class })
    public ResponseEntity<ApiError> handleRedisConnectionFailureException(
      Exception ex, WebRequest request) {
    	ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, "Redis Connection Exception", ex.getMessage());

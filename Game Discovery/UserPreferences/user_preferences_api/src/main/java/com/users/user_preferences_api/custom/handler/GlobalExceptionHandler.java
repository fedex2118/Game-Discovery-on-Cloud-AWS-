package com.users.user_preferences_api.custom.handler;
...
import com.users.user_preferences_api.custom.exception.ApiError;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> DataIntegrityViolationException(
      Exception ex, WebRequest request) {
    	ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, "Data Integrity Violation", ex.getMessage());
